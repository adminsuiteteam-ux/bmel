    ...
    <>
      ...
      <section className="bg-navy py-20 text-white relative">
        ...
        <div className="container-xl relative z-10 text-center">
          <span className="text-amber font-heading font-semibold text-sm uppercase tracking-widest">{t('contact.connect')}</span>
          <h1 className="text-4xl sm:text-5xl font-black mt-2">{t('contact.title')}</h1>
